...
export const BrandCard = (props: BrandCardProps) => {
  ...
  return (
    <Box display="flex" alignItems="center" justifyContent="center" backgroundColor="white" flexDirection="column" paddingX="12px" paddingY="20px" borderRadius="2px" cursor="pointer" onClick={openModal} maxWidth={300}>
